  ...
  return (
    <div className="bg-white font-sans text-gray-800">
      ...
      >
        ...
        <h1 className="relative olute z-10 text-white text-6xl md:text-8xl font-serif animate-pop-up">
          Contact Us
        </h1>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-[#004d43] text-white px-10 py-3 font-bold hover:bg-[#003333] transition-colors tracking-widest text-sm cursor-pointer"
              >
                SEND
              </button>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="mb-6">
                <h3 className="text-[#c08457] font-bold text-sm uppercase mb-2">
                  Tel:
                </h3>
